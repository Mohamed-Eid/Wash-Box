            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label d-flex justify-content-between w-100">
                        <h3 class="kt-portlet__head-title"> تعديل سائق </h3>
                    </div>
                </div>
                <!--END:: TITLE-->

                <!--START:: ADD NEW EMPLOYEE FORM-->
                <form class="kt-form p-3 " method="POST" action="{{ route('drivers.update',$driver) }}" enctype="multipart/form-data">
                    <div class="row">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="border mt-2">
                                    <img  width="150px" height="100px" src="{{ $driver->image_path }}" alt="your image" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="name" class="form-control {{ input_has_error('name',$errors) }}" value="{{ $driver->name }}" placeholder="الإسم">
                            ...
                            <div class="row">
                              ...
                              <div class="input-group-prepend col-12">
                                ...
                                <select class="form-control kt-selectpicker" name="area" id="cities" data-size="7" data-live-search="true">
                                    ...
                                    <option value="{{ $area->id }}" {{ $driver->area_id == $area->id ? 'selected' : '' }}> {{ $area->name . ' - '. $area->city->name }} </option>
                                    @endforeach
                                </select>
                              </div>
                            </div>
                        ...
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="email" value="{{ $driver->email }}" class="form-control" placeholder="البريد الإلكترونى">
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-12 col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="mobile" value="{{ $driver->mobile }}" class="form-control" placeholder="رقم الهاتف">
                                </div>
                            </div>
                        </div>
