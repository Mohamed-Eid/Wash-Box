        ...
        <div class="col-12">
            ...
            <div class="kt-portlet__head mb-3">
                <div class="kt-portlet__head-label d-flex align-items-center justify-content-between w-100">
                    ...
                    <div class="col-lg-4">
                        <div class="custom-portel kt-portlet kt-iconbox kt-iconbox--success kt-iconbox--animate">
                            <div class="kt-portlet__body p-0">
                                <div class="kt-iconbox__body flex-row-reverse justify-content-center">
                                    <div class="kt-iconbox__icon mx-3">
            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    ...
                    <table class="standard table table-responsive-sm" width="100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="right">
                                    <button type="button" class="kt-badge kt-badge--outline kt-badge--primary"
                                        data-skin="dark" data-toggle="modal" data-target="#edit-cat" title="تعديل">
                                        <i class="la la-edit"></i>
                                    </button>

                                    <a href="#" class="delete kt-badge kt-badge--outline kt-badge--danger"
                    ...
                    <!--begin:: Edit Modal-->
                    <div class="modal fade" id="edit-cat" tabindex="-1" role="dialog"
                                            ...
                                            <div class="form-group col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="input-group-prepend col-12">
                                                        <span class="input-group-text"> <i class="la la-map-marker"
            ...
            <!-- START:: MONY TRANSACTIONS SECTION -->
            <div class="kt-portlet">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label justify-content-center w-100">
                        <h3 class="kt-portlet__head-title kt-font-bolder"> التعاملات المالية </h3>
                    </div>
                </div>
                    ...
                    <table class="standard table table-responsive-sm" width="100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="custome-badge kt-badge kt-badge--success kt-badge--inline kt-badge--pill kt-badge--rounded p-2"
