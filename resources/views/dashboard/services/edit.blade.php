            ...
            <div class="kt-portlet">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title"> تعديل قائمة اسعار </h3>
                    </div>
                </div>

                <!--START:: ADD PRICE LIST FORM-->
                <form class="kt-form pb-0 p-3" method="POST" action="{{ route('services.update',$service) }}"  enctype="multipart/form-data">
                    <div class="row">
                        @csrf
                        @method('PUT')
                        <div class="form-group col-12 col-md-4">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="ar[name]" value="{{ $service->translate('ar')->name }}" class="form-control" placeholder=" اسم القائمه باللغة العربيه ">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-12 col-md-4">
                            <div class="row">
                                ...
                                <div class="input-group-prepend col-12">
                                    ...
                                    <input type="text" name="en[name]" value="{{ $service->translate('en')->name }}" class="form-control"
                        ...
                        <div class="form-group col-12 col-md-4">
                            <div class="row">
                                ...
                                <div class="offer-pic mt-3 mx-3">
                                    ...
                                    <img src="{{ $service->image_path }}" style="max-width: 150px" alt="..." class="offer-image-preview">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 my-2">
                            <div class="kt-form__group--inline">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" name="old_prices[{{$price->id}}][ar_name]" value="{{ $price->translate('ar')->name }}" class="form-control"
                        ...
                        <div class="col-6 my-2">
                            <div class="kt-form__group--inline">
                                ...
                                <div class="input-group-prepend">
                                    <span class="input-group-text"> <i class="la la-bookmark"
                                            style="font-size: 18px"></i> </span>
                                    <input type="text" name="old_prices[{{$price->id}}][en_name]" value="{{ $price->translate('en')->name }}" class="form-control"
                            ...
                            <div class="kt-form__group--inline">
                                ...
                                <div class="input-group-prepend">
                                    <span class="input-group-text"> <i class="la la-dollar"
                                            style="font-size: 18px"></i> </span>
                                    <input type="number" name="old_prices[{{$price->id}}][normal_cost]" value="{{ $price->normal_cost }}" min="0" class="form-control"
                        ...
                        <div class="col-6 my-2">
                            <div class="kt-form__group--inline">
                                ...
                                <div class="input-group-prepend">
                                    <span class="input-group-text"> <i class="la la-dollar"
                                            style="font-size: 18px"></i> </span>
                                    <input type="number" name="old_prices[{{$price->id}}][quick_cost]" value="{{ $price->quick_cost }}"  min="0" class="form-control"
